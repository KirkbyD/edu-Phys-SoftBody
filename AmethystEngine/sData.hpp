...
struct sData {
	...
	nAI::eFormationBehaviours GetFormation();
	void SetFormation(nAI::eFormationBehaviours formation);

	nAI::eAIBehviours GetSteeringBehaviour();
	void SetSteeringBehaviour(nAI::eAIBehviours steering);
...
private:
	...
	float _elapsed_time;
	glm::vec3 _velocity;
	nAI::eFormationBehaviours _formation;
	nAI::eAIBehviours _steering;
	float _flockWeight;
