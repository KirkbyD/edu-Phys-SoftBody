...
cActorObject::cActorObject(std::vector<cActorObject*>& vActors) {
	...
	_activeFormation = nAI::eFormationBehaviours::NONE;
...
nAI::eFormationBehaviours cActorObject::getActiveFormation() { return this->_activeFormation; }
void cActorObject::setActiveFormation(nAI::eFormationBehaviours formation) { this->_activeFormation = formation; }
