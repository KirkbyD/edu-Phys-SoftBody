...
nAI::eFormationBehaviours sData::GetFormation() { return this->_formation; }
void sData::SetFormation(nAI::eFormationBehaviours formation) { this->_formation = formation; }

nAI::eAIBehviours sData::GetSteeringBehaviour() { return this->_steering; }
void sData::SetSteeringBehaviour(nAI::eAIBehviours steering) { this->_steering = steering; }
